...
echo Command: ./test_cryptocopy -d -p wrongpassword tempfile.test outfile.test >> results
echo Command: ./test_cryptocopy -d -p wrongpassword tempfile.test outfile.test >> log

../test_cryptocopy -d -p wrongpassword tempfile.test outfile.test >> log
